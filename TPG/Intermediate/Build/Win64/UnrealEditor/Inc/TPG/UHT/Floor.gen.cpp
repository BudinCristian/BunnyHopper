...
// Cross Module References
	...
	TPG_API UClass* Z_Construct_UClass_AFloor();
	TPG_API UClass* Z_Construct_UClass_AFloor_NoRegister();
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AFloor_Statics::NewProp_StaticMesh = { "StaticMesh", nullptr, (EPropertyFlags)0x0020080000080009, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AFloor, StaticMesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AFloor_Statics::NewProp_StaticMesh_MetaData), Z_Construct_UClass_AFloor_Statics::NewProp_StaticMesh_MetaData) };
	...
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AFloor_Statics::PropPointers) < 2048);
	...
	template<> TPG_API UClass* StaticClass<AFloor>()
	{
		return AFloor::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(AFloor);
	AFloor::~AFloor() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_UE_GIT_BunnyHopper_TPG_Source_TPG_Floor_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_UE_GIT_BunnyHopper_TPG_Source_TPG_Floor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AFloor, AFloor::StaticClass, TEXT("AFloor"), &Z_Registration_Info_UClass_AFloor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AFloor), 2011777764U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_UE_GIT_BunnyHopper_TPG_Source_TPG_Floor_h_3910536963(TEXT("/Script/TPG"),
		Z_CompiledInDeferFile_FID_UnrealProjects_UE_GIT_BunnyHopper_TPG_Source_TPG_Floor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_UE_GIT_BunnyHopper_TPG_Source_TPG_Floor_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
